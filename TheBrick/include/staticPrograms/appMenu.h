...
class AppMenu : public StaticApp
{
  ...
  private:
    ...
    AppBase *appList[3][6] = {
        ...
        {&SysInfoAppNonStaticAppWrapper::Get(), &UsbmsAppNonStaticAppWrapper::Get(), &XmppAppNonStaticAppWrapper::Get(), &DummyAppNonStaticAppWrapper::Get(), &DummyAppNonStaticAppWrapper::Get(), &DummyAppNonStaticAppWrapper::Get()},
    };
